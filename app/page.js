...
const sampleItems = [
  {id:1,title:"PXG 배틀레디 배트어택 퍼터",price:420000,platform:"번개장터",location:"경기 성남시 분당구",region:"경기",time:"5분 전",condition:"거의 새상품",views:24,likes:12,chats:5,image:"https://images.unsplash.com/photo-1535131749006-b7f58c99034b?q=80&w=1200&auto=format&fit=crop",badge:"시세보다 18% 저렴",cheap:true,new:true,hidden:false,safe:true,desc:"현재 시세보다 약 18% 저렴해요. 컨디션이 매우 좋아 빠른 판매가 예상돼요!"},
  {id:2,title:"PXG 클로저 GEN2 퍼터 34인치",price:350000,platform:"번개장터",location:"서울 강남구",region:"서울",time:"7분 전",condition:"사용감 적음",views:18,likes:8,chats:2,image:"https://images.unsplash.com/photo-1592919505780-303950717480?q=80&w=1200&auto=format&fit=crop",badge:"시세보다 12% 저렴",cheap:true,new:true,hidden:false,safe:true,desc:"최근 평균가보다 저렴한 편이에요. 등록된 지 얼마 되지 않아 먼저 확인해볼 만해요."},
  {id:3,title:"PXG 헬캣 퍼터 33인치",price:300000,platform:"중고나라",location:"인천 연수구",region:"인천",time:"15분 전",condition:"사용감 있음",views:32,likes:5,chats:1,image:"https://images.unsplash.com/photo-1593111774240-d529f12cf4bb?q=80&w=1200&auto=format&fit=crop",badge:"평균 시세 수준",cheap:false,new:true,hidden:false,safe:false,desc:"가격은 평균 시세 수준이에요. 상태 사진을 꼼꼼히 확인하는 것이 좋아요."},
  {id:4,title:"PXG 스파이더 퍼터 일자형",price:280000,platform:"네이버카페",location:"골프사랑 카페",region:"서울",time:"20분 전",condition:"사용감 적음",views:13,likes:3,chats:0,image:"https://images.unsplash.com/photo-1530028828-25e8270793c5?q=80&w=1200&auto=format&fit=crop",badge:"숨은 매물",cheap:true,new:false,hidden:true,safe:false,desc:"조회수는 낮지만 가격이 좋은 숨은 매물이에요. 카페 거래 특성상 판매자 확인이 필요해요."},
  {id:5,title:"PXG 트랜스포머 퍼터 33인치",price:450000,platform:"당근마켓",location:"경기 용인시 수지구",region:"경기",time:"25분 전",condition:"거의 새상품",views:41,likes:9,chats:4,image:"https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?q=80&w=1200&auto=format&fit=crop",badge:"인기 상승",cheap:false,new:false,hidden:false,safe:false,desc:"조회와 찜 반응이 빠르게 올라가고 있어요. 가격 협상 가능 여부를 확인해보세요."},
  {id:6,title:"아이폰 15 프로 256GB 내추럴 티타늄",price:980000,platform:"번개장터",location:"서울 마포구",region:"서울",time:"12분 전",condition:"사용감 적음",views:305,likes:27,chats:11,image:"https://images.unsplash.com/photo-1695048133142-1a20484d2569?q=80&w=1200&auto=format&fit=crop",badge:"인기 검색 매물",cheap:false,new:true,hidden:false,safe:true,desc:"조회수가 빠르게 올라가고 있는 인기 매물이에요."},
  {id:7,title:"플레이스테이션5 디스크 에디션 풀박스",price:430000,platform:"중고나라",location:"경기 고양시 덕양구",region:"경기",time:"9분 전",condition:"사용감 적음",views:112,likes:15,chats:6,image:"https://images.unsplash.com/photo-1606813907291-d86efa9b94db?q=80&w=1200&auto=format&fit=crop",badge:"방금 등록",cheap:true,new:true,hidden:false,safe:true,desc:"최근 검색량이 높은 인기 상품이에요. 풀박스 구성이라 비교적 빠르게 판매될 수 있어요."}
];
...
export default function Home() {
  ...
  const search = () => { setSubmittedQuery(query.trim() || "PXG 퍼터"); setCheapOnly(false); setNewOnly(false); setSafeOnly(false); setHiddenOnly(false); setSelectedId(null); setActiveMobileTab("검색"); };
